...
const Input = ({ receiverId, currentUserId }: InputProps) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex items-center justify-center p-2 text-gray-900 bg-orange-500 rounded-lg curser-pointer hover:bg-orange-500 disabled:opcity-60"
      >
